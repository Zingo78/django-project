...
class TopicViews(View):
    ...
    def make_topic_res(self, author, author_topic, is_self):
        ...
        # print(id)
        # print(author_topic.id)
        # print(author_topic.title)
    ...
    def make_topics_res(self, author, author_topics):
        ...
        res['data']['nick_name'] = author.nickname
        return res
    ...
    def get(self, request, author_id):
        ...
        if t_id:
            ...
            # 获取列表页数据
            # v1/topic/guoxiaonao
            # v1/topic/guoxiaonao?category=[tec|no-tec]
    ...
    def delete(self, request, author_id):
        ...
        if t_id:
            t_id = int(t_id)
            try:
                obj = Topic.objects.get(id=t_id, author_id=author_id)
                # print(obj)
                print(obj, 'test')
            except Exception as e:
                print(Topic.id, 'test1')
                result = {'code': 10301, 'error': 'The topic is not existed'}
                # print('件里添1')
            obj.delete()
        result = {'code': 200}
        # 删除缓存
